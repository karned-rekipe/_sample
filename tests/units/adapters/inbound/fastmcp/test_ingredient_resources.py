...
from arclith_sample.adapters.inbound.fastmcp.resources import IngredientResources
...
async def client(service, logger, mcp_app):
    with patch("arclith_sample.adapters.inbound.fastmcp.resources.ingredient_resources.inject_tenant_uri", new=AsyncMock()):
