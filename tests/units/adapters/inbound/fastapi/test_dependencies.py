"""Tests for adapters/inbound/fastapi/dependencies.py."""
...
async def test_inject_tenant_uri_is_cached():
    ...
    from arclith_sample.adapters.inbound.fastapi.dependencies import _get_inject_fn
...
def test_require_auth_fn_is_cached():
    ...
    with patch("arclith_sample.adapters.inbound.fastapi.dependencies.load_config_dir") as mock_config:
        ...
        # Clear cache first
        from arclith_sample.adapters.inbound.fastapi.dependencies import _get_require_auth_fn
...
async def test_require_auth_with_valid_token():
    ...
    from arclith_sample.adapters.inbound.fastapi.dependencies import require_auth
