...
async def test_inject_tenant_uri_with_none_context():
    ...
    from arclith_sample.adapters.input.fastmcp.dependencies import inject_tenant_uri
...
def test_inject_fn_is_cached():
    ...
    from arclith_sample.adapters.input.fastmcp.dependencies import _get_inject_fn
...
def test_require_auth_mcp_fn_is_cached():
    ...
    with patch("arclith_sample.adapters.input.fastmcp.dependencies.load_config_dir") as mock_config:
        ...
        # Clear cache first
        from arclith_sample.adapters.input.fastmcp.dependencies import _get_require_auth_mcp_fn
...
async def test_require_auth_mcp_with_none_context_raises():
    ...
    from arclith_sample.adapters.input.fastmcp.dependencies import require_auth_mcp
